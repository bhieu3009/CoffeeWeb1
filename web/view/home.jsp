<%-- 
    Document   : home
    Created on : Mar 11, 2024, 11:10:47 PM
    Author     : MinHee
--%>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <c:if test="${sessionScope.acc !=null}" >
                            <li class="nav-item"><a href="contact.html" class="nav-link">Hello ${sessionScope.acc.username}</a></li>
                            <li class="nav-item"><a href="logout" class="nav-link">Logout</a></li>
                            </c:if>
                            <c:if test="${sessionScope.acc ==null}" >
                            <li class="nav-item"><a href="login" class="nav-link">Login</a></li>
                            </c:if>
                        <li class="nav-item cart"><a href="order" class="nav-link"><span class="icon icon-shopping_cart"></span><span class="bag d-flex justify-content-center align-items-center"><small>1</small></span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
